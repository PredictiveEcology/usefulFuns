#' Provides an easy way of modifying species traits table in `LandR` by
#' multiplication of original traits by a specified factor
#'
#' @param speciesTable `speciesTable` object (`data.table`) from `LandR`.
#'                     Contains different traits in columns and  a row for each species.
#'
...
#'
#' @return A `data.table` updated with the new parameters.
#' @export
